            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            <a href="/admin/basisp" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="/admin/riwayat_pengguna" class="nav-link">
                ...
                <div class="container-fluid col-11">
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-6 col-md-3">
                            <div class="info-box">
                                <span class="info-box-icon bg-info elevation-1"><i class="fas fa-file-medical"></i></span>
                        ...
                        <div class="col-12 col-sm-6 col-md-3">
                            <div class="info-box mb-3">
                                <span class="info-box-icon bg-success elevation-1"><i class="fas fa-frown"></i></span>

                                <div class="info-box-content">
                                    <span class="info-box-text"><?= $namstres['nama_penyakit']; ?></span>
                                    <span class="info-box-number">
                                        <?= $stres['id_hasil']; ?>
                                    </span>
                                </div>
                        ...
                        <div class="col-12 col-sm-6 col-md-3">
                            <div class="info-box mb-3">
                                <span class="info-box-icon bg-warning elevation-1"><i class="fas fa-frown-open text-white"></i></span>

                                <div class="info-box-content">
                                    <span class="info-box-text"><?= $namcemas['nama_penyakit']; ?></span>
                                    <span class="info-box-number">
                                        <?= $cemas['id_hasil']; ?>
                                    </span>
                                </div>
                        ...
                        <div class="col-12 col-sm-6 col-md-3">
                            <div class="info-box mb-3">
                                <span class="info-box-icon bg-danger elevation-1"><i class="fas fa-sad-cry"></i></span>

                                <div class="info-box-content">
                                    <span class="info-box-text"><?= $namdepresi['nama_penyakit']; ?></span>
                                    <span class="info-box-number">
                                        <?= $depresi['id_hasil']; ?>
                                    </span>
                                </div>
